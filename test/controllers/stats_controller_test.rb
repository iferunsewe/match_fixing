...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { appearances: @stat.appearances, goals: @stat.goals, man_of_the_match: @stat.man_of_the_match }
    end
  ...
  test "should update stat" do
    patch :update, id: @stat, stat: { appearances: @stat.appearances, goals: @stat.goals, man_of_the_match: @stat.man_of_the_match }
    assert_redirected_to stat_path(assigns(:stat))
  end
